...
public class Main {
    ...
    private static final String MARKET = "TW";
    private static final String EXCHANGE = "FTSE";
    private static final String SYMBOL = "FTSE:000040";
                ...
                .buildAsync(URI.create(WS_URL), new WebSocket.Listener() {
                    ...
                    public void onOpen(WebSocket webSocket) {
                        String subscribeJson = "{\"action\":\"subscribe\",\"market\":\"" + MARKET
                                + "\",\"exchange\":\"" + EXCHANGE
                                + "\",\"symbols\":[\"FTSE:000040\",\"FTSE:005930\"],\"replay\":\"last\"}";
